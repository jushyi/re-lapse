...
@.planning/ROADMAP.md
@.planning/STATE.md
@.planning/phases/18.3-triage-animation-zindex-suction/18.3-CONTEXT.md
...
<output>
After completion, create `.planning/phases/18.3-triage-animation-zindex-suction/18.3-01-SUMMARY.md`:
...
Phase 18.3 complete, ready for next phase
</output>
