...
<objective>
Create documentation for the custom palette editor with color pickers.

Purpose: Guide for building a custom theme editor where users can customize 5 colors.
Output: 05-CUSTOM-EDITOR.md in docs/phase-25/
</objective>
...
<task type="auto">
  <name>Task 1: Create Custom Editor guide</name>
  <files>docs/phase-25/05-CUSTOM-EDITOR.md</files>
  <action>
Create the custom theme editor tutorial:
...
```
  ...
  <verify>docs/phase-25/05-CUSTOM-EDITOR.md created</verify>
  <done>Custom editor tutorial created</done>
</task>
...
- [ ] docs/phase-25/05-CUSTOM-EDITOR.md created
- [ ] Tutorial covers color picker library installation
- [ ] ColorPickerRow component with modal explained
- [ ] CustomThemeEditorScreen with all 5 colors documented
- [ ] ThemeContext updates explained
- [ ] Complete code solutions provided
</verification>

<success_criteria>
- Junior developer can build custom theme editor
- Color picker integration clearly explained
- Persistence pattern documented
</success_criteria>
