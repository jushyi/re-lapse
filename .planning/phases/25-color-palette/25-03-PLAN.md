...
<objective>
Create documentation for the Appearance settings screen with theme selection UI.

Purpose: Guide for building the Settings → Appearance screen with preview/apply flow.
Output: 04-SETTINGS-UI.md in docs/phase-25/
</objective>
...
<task type="auto">
  <name>Task 1: Create Settings UI guide</name>
  <files>docs/phase-25/04-SETTINGS-UI.md</files>
  <action>
Create the settings screen tutorial:
...
```
  ...
  <verify>docs/phase-25/04-SETTINGS-UI.md created</verify>
  <done>Settings UI tutorial created</done>
</task>
...
- [ ] docs/phase-25/04-SETTINGS-UI.md created
- [ ] Tutorial covers preview/apply pattern
- [ ] Navigation setup explained
- [ ] Complete code solutions provided
</verification>

<success_criteria>
- Junior developer can build AppearanceSettingsScreen
- Preview/apply flow clearly explained
