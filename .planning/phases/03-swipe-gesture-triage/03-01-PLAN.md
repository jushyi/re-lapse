...
**Swipe Actions:**
- Left swipe reveals Archive action (red background, 📦 icon, "Archive" text)
- Right swipe reveals Journal action (blue background, 📖 icon, "Journal" text)
- Action width: 120px (enough to show icon + text clearly)
- Action background colors: Archive #FF3B30 (red), Journal #007AFF (blue) - match iOS system colors
...
- Action labels fade in as user swipes (opacity 0 → 1 based on swipe progress)
- Action icons scale in (scale 0.8 → 1) for spring effect
...
- Action background opacity: 0 at 0px → 1 at 60px swipe
- Action text opacity: 0 at 0px → 1 at 80px swipe
- Action icon scale: 0.5 at 0px → 1.0 at 100px swipe
- Photo scale: 1.0 at 0px → 0.98 at 60px swipe (subtle zoom-out)
...
**Action Label Layout:**
- Archive action (left): Red background (#FF3B30), white text, centered icon + label
- Journal action (right): Blue background (#007AFF), white text, centered icon + label
...
**Why progressive feedback matters:** iOS Mail provides continuous visual feedback during swipe (action becomes more visible/prominent as you swipe further). This creates natural affordance and confirms the gesture is working.
  ...
  <verify>
Swipe left shows progressively visible Archive action (red background, 📦 icon).
Swipe right shows progressively visible Journal action (blue background, 📖 icon).
